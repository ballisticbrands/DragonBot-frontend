...
// landing URL) into localStorage before anything else runs. First-touch
// wins — if we've already captured on a prior page load, this is a
// no-op. The sign-up form reads the blob and POSTs it to the backend.
